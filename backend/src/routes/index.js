...
const aiMetadataRoutes = require("../modules/ai-metadata/aiMetadata.routes");
...
const metaIntegrationRoutes = require("../modules/integrations/meta.routes");
...
router.use("/ai", aiMetadataRoutes);
...
router.use("/integrations/meta", metaIntegrationRoutes);
